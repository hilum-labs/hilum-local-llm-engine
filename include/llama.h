...
extern "C" {
    ...
    // Load the model from an in-memory buffer containing a complete GGUF file.
    // The buffer must remain valid for the lifetime of the returned model.
    // Split models are not supported via this interface.
